...
import { Fluids, ITEMS, ZLBFTraitsEnum } from "@constants";
...
const isPregnant = (character: IsoGameCharacter): boolean => {
	...
	return CharacterTraitApi.hasTrait(character as IsoPlayer, ZLBFTraitsEnum.PREGNANCY);
};
 ...
 */
export const ZLBFRecipeTests: Record<string, RecipeTest> = {
...
declare let ZLBFRecipes: { OnTest?: Record<string, RecipeTest> };
ZLBFRecipes = ZLBFRecipes ?? {};
ZLBFRecipes.OnTest = ZLBFRecipeTests;
